...
# лента в машине не нуждается: tools/no-x-build.sh уже показал, что её
# арифметика не берёт у X11 ничего, а весь договор с внешним миром - десять
# функций.  Значит ribbon.c компилируется прямо в WebAssembly, а десять
# функций пишет страница (tools/wasm-layout/shim.c).
#
